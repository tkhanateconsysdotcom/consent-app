...
it("PartnersListItem renders correctly if mitigated", () => {
  const tree = create(
...
it("PartnersListItem renders correctly with redMeat icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with whiteMeat icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with chocolate icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with coffee icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with fish icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with boat icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with bus icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with car icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with longHaulFlight icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with mediumHaulFlight icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with motorbike icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with shortHaulFlight icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with train icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with hd video icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with audio icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with full hd video icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
...
it("PartnersListItem renders correctly with ultra hd video icon", () => {
  const tree = create(
    <FormattedProvider locale="en">
      <PartnersListItem
        {...props}
